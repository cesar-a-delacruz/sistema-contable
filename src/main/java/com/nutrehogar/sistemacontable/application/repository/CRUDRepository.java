 ...
 *
 * @param <T>
 *            El tipo de la entidad gestionada por este repositorio.
 * @param <ID>
 *            El tipo del identificador único de la entidad.
 */
public interface CRUDRepository<T, ID> extends SimpleRepository<T> {
     ...
     * @return Un {@link Optional} que contiene la entidad si se encuentra, o vacío
     *         si no existe.
     * @throws IllegalArgumentException
     *             Si el argumento {@code id} o {@code entityClass} es nulo.
     */
     ...
     *
     * @return Una lista de todas las entidades. Si no hay entidades, devuelve una
     *         lista vacía.
     */
     ...
     * Si la entidad ya existe, puede lanzar una excepción o actualizarla,
     * dependiendo de la implementación.
     *
     * @param entity
     *            La entidad a guardar.
     * @throws IllegalArgumentException
     *             Si la entidad es null o no es una entidad gestionada.
     * @throws EntityExistsException
     *             Si ya existe una entidad con el mismo identificador en la base de
     *             datos.
     * @throws ConstraintViolationException
     *             Si se viola una restricción de la base de datos (clave única, not
     *             null, etc.).
     */
     ...
     * Si alguna entidad ya existe, puede lanzar una excepción o actualizarla,
     * dependiendo de la implementación.
     *
     * @param entities
     *            La lista de entidades a guardar.
     * @throws IllegalArgumentException
     *             Si la entidad es null o no es una entidad gestionada.
     * @throws EntityExistsException
     *             Si ya existe una entidad con el mismo identificador en la base de
     ...
     * Si la entidad no existe, puede lanzar una excepción o crearla, dependiendo de
     * la implementación.
     *
     * @param entity
     *            La entidad a actualizar.
     * @throws IllegalArgumentException
     *             Si la entidad es null o no es válida.
     * @throws ObjectDeletedException
     *             Si se intenta actualizar una entidad que ha sido eliminada.
     * @throws OptimisticLockException
     *             Si hay problemas de concurrencia (bloqueos o versiones
     *             desactualizadas).
     * @throws ConstraintViolationException
     *             Si se violan restricciones de la base de datos.
     */
    T update(T entity) throws RepositoryException, ExecutionException, InterruptedException;

    /**
     * Elimina una entidad del repositorio.
     * Si la entidad no existe, puede lanzar una excepción o no hacer nada,
     * dependiendo de la implementación.
     *
     * @param entity
     ...
     *
     * @param id
     *            El identificador único de la entidad a eliminar.
     * @throws IllegalArgumentException
     *             Si el identificador es nulo.
     */
