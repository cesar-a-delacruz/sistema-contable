 ...
 */
public class InTransactionWorker extends SwingWorker<Void, Void> {
    /**
     ...
     */
    @NotNull
    private final Consumer<Session> work;
    /**
    ...
    public InTransactionWorker(@NotNull Consumer<Session> work, @NotNull Runnable onSuccess, @NotNull Consumer<ApplicationException> onFailure) {
        this.work = work;
